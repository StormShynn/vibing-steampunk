...
| Metric | Focused (105 tools) | Expert (156 tools) | Hyperfocused (1 tool) |
|--------|-------------------:|-------------------:|----------------------:|
...
| **Hyperfocused Mode** | 1 universal SAP tool, **~200 tokens** vs ~40K for 156 tools |
...
```mermaid
graph LR
    F["focused<br/>105 tools<br/>~14K tokens"] --> E["expert<br/>156 tools<br/>~40K tokens"]
