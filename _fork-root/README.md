...
| Metric | Focused (115 tools) | Expert (166 tools) | Hyperfocused (1 tool) |
|--------|-------------------:|-------------------:|----------------------:|
...
| **Hyperfocused Mode** | 1 universal SAP tool, **~200 tokens** vs ~40K for 166 tools |
...
```mermaid
graph LR
    F["focused<br/>115 tools<br/>~14K tokens"] --> E["expert<br/>166 tools<br/>~40K tokens"]
